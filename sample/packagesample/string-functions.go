...
import s "strings"  // like python import as
import "fmt"
...
func StringFunc() {
	...
	// Note that these are all functions from package,
	...
	// Not part of strings but worth mentioning here are the mechanisms
	// for getting the length of a string and getting a character by index.
    p("Len: ", len("hello"))
    p("Char:", "hello"[1])
}