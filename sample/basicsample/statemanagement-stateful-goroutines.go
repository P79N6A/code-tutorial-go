/*
	Stateful Goroutines:
		...
		Another option is to use the built-in synchronization features of goroutines
...
// These readOp and writeOp structs encapsulate those requests and
// a way for the owning goroutine to respond.
type readOp struct {
    key  int
    resp chan int
}
